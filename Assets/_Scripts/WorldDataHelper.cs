...
public static class WorldDataHelper
{
    ...
    internal static List<Vector3Int> GetChunkPositionsAroundPlayer(World world, Vector3Int playerPosition)
    {
        ...
        for (int x = startX; x <= endX; x += world.chunkSize)
        {
            ...
            {
                var chunkPos = ChunkPositionFromBlockCoords(world, new Vector3Int(x, 0, z));
    ...
    internal static List<Vector3Int> GetDataPositionsAroundPlayer(World world, Vector3Int playerPosition) // could refactor code to have int j in init with 0 in above and int 1 here
    {
